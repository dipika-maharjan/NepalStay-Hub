...
export default function AdminAccommodationsPage() {
  ...
  const handleDelete = async (
    ...
    if (!confirm(`Are you sure you want to delete "${accommodationTitle}"?`)) {
      return;
    }
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-4 rounded-lg shadow">
        ...
        {searchQuery && (
          <p className="text-sm text-gray-600 mt-2">
            Found {filteredAccommodations.length} result
            {filteredAccommodations.length !== 1 ? "s" : ""} for "{searchQuery}"
          </p>
        )}
      </div>
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
                ...
                <tr key={accommodation._id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="h-16 w-16 rounded-lg overflow-hidden bg-gray-100 flex items-center justify-center">
                      ...
                      accommodation.images.length > 0 ? (
                        <img
                          src={normalizeImageUrl(accommodation.images[0])}
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">
                      ⭐ {(accommodation.rating ?? 0).toFixed(1)} (
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <button
                        onClick={() =>
                          handleDelete(accommodation._id, accommodation.title)
                        }
        ...
        {filteredAccommodations.length > 0 && (
          <div className="p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-t border-gray-100">
            <div className="text-sm text-gray-600">
              ...
              of {filteredAccommodations.length} accommodations
            </div>
