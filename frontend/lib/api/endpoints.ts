...
export const API = {
  ...
  BOOKING: {
    CREATE: "/api/bookings",
    GET_ALL: "/api/bookings/admin/all",
  ...
  REVIEW: {
    CREATE: "/api/reviews",
    GET_ALL: (accommodationId: string, page = 1, limit = 5, sort = "latest") =>
      `/api/reviews?accommodationId=${accommodationId}&page=${page}&limit=${limit}&sort=${sort}`,
