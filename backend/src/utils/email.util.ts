...
export const sendVerificationEmail = async (
  ...
  await transporter.sendMail({
    from: `"NepalStayHub" <${process.env.EMAIL_USER}>`,
    to: email,
    subject: "Verify your NepalStayHub account",
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2 style="color: #2563eb;">NepalStayHub Email Verification</h2>
...
export const sendPasswordResetEmail = async (
  ...
  await transporter.sendMail({
    from: `"NepalStayHub" <${process.env.EMAIL_USER}>`,
    to: email,
    subject: "Reset your NepalStayHub password",
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
...
export const sendAccountLockedEmail = async (
  ...
  await transporter.sendMail({
    from: `"NepalStayHub" <${process.env.EMAIL_USER}>`,
    to: email,
    subject: "NepalStayHub: Account temporarily locked",
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
