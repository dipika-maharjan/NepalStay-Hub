...
import {
  getAccommodationByIdAdmin,
  updateAccommodation,
} from "@/lib/api/admin/accommodation";
...
export default function EditAccommodationPage({
  ...
  const fetchAccommodation = async () => {
    try {
      ...
      if (response.success) {
        ...
        setEcoFriendlyHighlights(
          data.ecoFriendlyHighlights.length > 0
            ? data.ecoFriendlyHighlights
            : [""],
        );
      }
    } catch (error: any) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const filteredHighlights = ecoFriendlyHighlights.filter(
        (e) => e.trim() !== "",
      );
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-xl sm:text-2xl font-bold text-gray-800">Edit Accommodation</h1>
      </div>
      ...
      >
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-800 mb-2">
              ...
              <span className="text-gray-500 text-sm font-normal">
                (optional - upload files or add URLs)
              </span>
            </h2>
            ...
            <div className="mb-4">
              ...
              <div
                ...
                className="border-2 border-dashed border-gray-300 rounded-lg p-6 sm:p-8 text-center cursor-pointer hover:border-[#0c7272] transition-colors"
              >
            ...
            <div key={index} className="flex gap-2">
              ...
              {amenities.length > 1 && (
                <button
                  type="button"
                  onClick={() =>
                    removeArrayItem(index, setAmenities, amenities)
                  }
                  className="text-red-600 hover:text-red-800"
                >
                  <X size={20} />
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button
              type="button"
              onClick={() =>
                addArrayItem(setEcoFriendlyHighlights, ecoFriendlyHighlights)
              }
              className="flex items-center gap-1 text-[#0c7272] hover:text-[#0a5555] text-sm"
            >
        ...
        <div className="flex flex-col sm:flex-row gap-4 pt-4">
          <button
            type="submit"
            disabled={submitting}
            className="w-full sm:flex-1 bg-[#0c7272] text-white py-2 px-4 rounded-lg hover:bg-[#0a5555] transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {submitting ? "Updating..." : "Update Accommodation"}
          </button>
          <Link
            href="/admin/accommodations"
            className="w-full sm:flex-1 text-center border border-gray-300 text-gray-700 py-2 px-4 rounded-lg hover:bg-gray-50 transition"
          >
            Cancel
          </Link>
        </div>
