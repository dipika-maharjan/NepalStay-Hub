...
export default function AccommodationsPage() {
  ...
  const handlePriceFilter = async () => {
    ...
    try {
      setIsSearching(true);
      setCurrentPage(1); // Reset to first page
      const response = await getAccommodationsByPriceRange(
        Number(minPrice),
        Number(maxPrice),
      );
      if (response.success) {
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="mb-6">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-4">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-[#0c7272] mb-1">
                Find Your Perfect Accommodations
              </h1>
              <p className="text-gray-600 text-sm">
                Discover sustainable stays across Nepal
              </p>
            </div>
          ...
          <>
            ...
            <div className="mb-4 flex items-center justify-between">
              <p className="text-gray-600 text-sm">
                ...
                {Math.min(indexOfLastItem, accommodations.length)} of{" "}
              ...
              {currentAccommodations.map((accommodation) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Content */}
                    <div className="p-4">
                      <h3 className="font-bold text-base text-[#0c7272] mb-1.5 line-clamp-1 group-hover:text-[#134e4a] transition">
                        {displayTitle}
                      </h3>
